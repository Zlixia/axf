    ...
    <div class="main">
      ...
      <div class="inputs">
        <div class="phone-padding spline-bottom">
          <input class="phone" v-model="phone" type="tel" placeholder="手机号码" 
          @focus="picHidefocus" @blur="picHideBlue">
        </div>
      </div>
